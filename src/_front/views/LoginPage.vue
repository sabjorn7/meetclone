        ...
        <div class="pd-auth">
            ...
            <aside class="pd-auth__brand">
                <div class="pd-auth__brandinner">
                    ...
                    <img class="pd-auth__art" src="/images/minime-06.png" alt="" aria-hidden="true" />
                </div>
            </aside>
...
.pd-auth__art { display: block; width: 118px; height: auto; margin: 40px 0 0; opacity: 0.96; filter: drop-shadow(0 20px 30px rgba(0, 0, 0, 0.25)); }
