...
@media (max-width: 640px) {
    ...
    /* stacked layout: no height-matching needed, so show the full title and roomier padding */
    .pd-erow__title { display: block; -webkit-line-clamp: initial; overflow: visible; }
    .pd-erow__body { padding: 18px 22px; justify-content: flex-start; }
}
</style>
